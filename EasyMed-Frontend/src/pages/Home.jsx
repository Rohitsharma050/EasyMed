...
export default function Home() {
  return (
    <>
      <section id='home'>
        {/* ✅ Removed 'p-4' from this div, as it was causing conflicts.
           The padding for the top is now handled by the parent MainPage.
           Keep other styling as needed for layout.
        */}
